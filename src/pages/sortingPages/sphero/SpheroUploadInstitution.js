        ...
        reader.onload = () => {
            csv.parse(reader.result, (err, data) => {
                ...
                for (var i = 1; i < data.length; i++) {
                    ...
                    fire.database().ref("SpheroElementary/institutions").set(name);
                    fire.database().ref("SpheroElementary/institutions/"+name).set(newInstitution);
                };
            });
        };
...
export default SpheroUploadInstitutionsPage;