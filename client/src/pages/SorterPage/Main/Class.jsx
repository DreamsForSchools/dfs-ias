...
const Class = ({
    ...
    const preference = [
        {
            value: 'Mobile App Development (AppJam+)',
            label: 'AppJam',
        },
        {
        ...
        {
            value: "Let's Explore STEM",
            label: 'LESTEM',
        },
        {
            value: 'Coding Games with Scratch',
            label: 'Scratch',
        },
        {
            value: 'Engineering Inventors',
            label: 'Engineering Inventors',
        },
    ];
  ...
  */
    ...
    useEffect(() => {
        ...
        for (const i in instructors) {
            let preferences = [
                instructors[i].firstPref,
                instructors[i].secondPref,
                instructors[i].thirdPref,
                instructors[i].fourthPref,
            ];
            if (checkedItems.car.includes(instructors[i].hasCar)) {
                ...
                console.log(
                    instructors[i].firstName + ' matches Preference criteria'
                );
            } else if (checkedItems.year.includes(instructors[i].schoolYear)) {
                console.log(
                    instructors[i].firstName + ' matches school year criteria'
                );
            } else {
                console.log(
                    instructors[i].firstName +
                        ' does NOT match Filtered Criteria'
                );
            }
        }
                    ...
                    >
                        ...
                        >
                            <ReactMultiSelectCheckboxes
                                ...
                                filters={filters}
                                onChange={(e) => {
                                    handleCheckboxChange(e, 'preference');
                                }}
                                //value={selectedOptions}
                                //onChange={onChange}
                            />
