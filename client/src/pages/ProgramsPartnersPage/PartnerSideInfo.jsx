...
const PartnerSideInfo = (props) => {
    ...
    function formatInstructorsNeededString(instructorCount) {
        return instructorCount === 0
            ? 'No instructor count defined.'
            : `Instructors needed: ${instructorCount}`;
    }
        ...
        <Wrapper>
            ...
            <div>
                ...
                <div style={{ margin: '1rem 0' }}>
                    <Button
                        style={{ width: '12rem' }}
                        onClick={() => onDuplicatePartner(partner, false)}
                        data-testid="editPartner">
                        Edit Partner
                ...
                <div style={{ margin: '1rem 0' }}>
                    <Button
                        style={{ width: '12rem' }}
                        variant="success"
                        onClick={() => onDuplicatePartner(partner, true)}
                        data-testid="duplicatePartner">
                        Duplicate Partner
                        <span style={{ marginLeft: '0.5rem' }}>
                            <Clipboard />
                        </span>
                ...
                <div style={{ margin: '2rem 0' }}>
                    <PartnerSymbol>
                        {partnerSymbols[partner.partnerType]}️
                    </PartnerSymbol>
                </div>
                <Subtitle>
                    <PeopleFill />
                ...
                <Subtitle>
                    <GeoAltFill />
                    <span style={{ marginLeft: '1rem' }}>
                        {partner.street}, {partner.city}, {partner.state}{' '}
                        {partner.zip}
                    </span>
                </Subtitle>
                ...
                <div className={'grouped-info_container'}>
                    <div
                        ...
                        <h6>{partner.langRequest}</h6>
                    </div>
                </div>
                <Button
                    variant="info"
                    onClick={() => props.openModal('ClassToPartner')}>
                    Add Classes
                    <span style={{ marginLeft: '0.5rem' }}>
                        <PencilSquare />
                    </span>
                ...
                <Modal
                    ...
                    <Modal.Footer style={{ border: '0' }}>
                        ...
                        <Button
                            ...
                            data-testid="deletePartnerConfirm">
                            Confirm
                        </Button>
                    </Modal.Footer>
                </Modal>
