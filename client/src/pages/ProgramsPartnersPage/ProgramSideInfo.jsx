        ...
        <Wrapper>
            {/* <Fade right duration={200}> */}
                <div>
                    ...
                    <Button variant="danger" onClick={() => onDeleteShow(null)} data-testid="deleteProgram">Delete Program
                    ...
                    <Button variant="info" onClick={() => props.openModal('ClassToProgram')} data-testid="addClass">Add Classes
                    ...
                    { program.classes.map((e, idx) =>
                        <ProgramSection key={idx}>
                            ...
                            <div style={{marginTop: '1rem'}}>
                                <Button size="sm" style={{marginRight: '0.5rem', marginBottom: '0.5rem'}}
                                        onClick={() => onDuplicateClass(e, false)} data-testid="editClass">Edit
                                    <span style={{marginLeft: '0.5rem'}}><PencilSquare/></span>
                                </Button>
                                <Button variant="danger"
                                        style={{marginRight: '0.5rem', marginBottom: '0.5rem'}}
                                        size="sm"
                                        onClick={() => onDeleteShow(e.classId)} data-testid="deleteClass">Delete
                                    <span style={{marginLeft: '0.5rem'}}><Trash/></span>
                                </Button>
                                <Button variant="success"
                                        size="sm"
                                        style={{marginRight: '0.5rem', marginBottom: '0.5rem'}}
                                        onClick={() => onDuplicateClass(e, true)} data-testid="duplicateClass">Duplicate
                    ...
                    <Modal show={deleteShow}
                        ...
                        <Modal.Body style={{padding: '1rem 3rem'}}>Do you want to delete this { currentClassId ? 'class' : 'program' }?</Modal.Body>
