...
const AddClassToPartnerModal = ({ handleSubmit, partnerContext }) => {
    ...
    const handleSubmitButtonPress = () => {
        ...
        //         ? Number(
        //               newClassInput.programId.substr(
        //                   0,
        //                   newClassInput.programId.indexOf(' ')
        //               )
        //           )
        //         : null,
    ...
    return (
        <>
            <Modal.Header
                ...
                <Modal.Title>
                    Create a new class for {seasonSelected.name}
                </Modal.Title>
            </Modal.Header>
            <>
                <Modal.Body>
                    <div
                        ...
                        <div
                            ...
                            <PartnerSymbol>
                                {partnerSymbols[partnerContext.partnerType]}️
                            </PartnerSymbol>
                        </div>
                ...
                <Modal.Footer
                    ...
                    <Button variant="primary" onClick={handleSubmitButtonPress}>
                        Submit
                    </Button>
                </Modal.Footer>
            </>
